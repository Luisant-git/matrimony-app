...
const Logo = ({ onClick }) => (
  <button onClick={onClick} className="flex items-center space-x-2 focus:outline-none">
    ...
    <span className="font-bold text-xl text-primary">MATRIMONY</span>
  </button>
);
...
const Header = ({ onNavigateHome, onNavigateToLogin, onNavigateToRegister, onNavigateToAbout, onNavigateToContact, onNavigateToWishlist, currentPage }) => {
          ...
          {currentPage !== 'login' ? (
            <>
              ...
              <div className="hidden md:block">
                ...
                (
                  <>
                  <button onClick={onNavigateToLogin} className="bg-primary text-white font-semibold py-2 px-6 rounded-md hover:bg-primary-dark transition-colors shadow mr-4">
                    Login 
                  </button>

                  <button onClick={onNavigateToRegister} className='bg-primary text-white font-semibold py-2 px-6 rounded-md hover:bg-primary-dark transition-colors shadow'>
                    Register
                  </button>
