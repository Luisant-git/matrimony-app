  ...
  return (
    <header className="">
        <div className={`jm-header-area header-sticky ? 'sticky': ''}`}>
            <div className="container border shadow-sm mt-3 p-2">
                    ...
                    <div className="row align-items-center ">
                        ...
                        <div className="col-xl-3 col-lg-3 col-5">
                            <div className="  text-end d-flex align-items-center justify-content-end">
                                ...
                                <Link to="/" className="jm-theme-btn d-none d-lg-block  ">Home</Link>
                                <div className="jm-navbar-mobile-sign side-toggle d-lg-none d-inline-block" role='button'>
